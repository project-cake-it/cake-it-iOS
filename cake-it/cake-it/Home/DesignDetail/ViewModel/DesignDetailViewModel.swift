...
class DesignDetailViewModel {
  ...
  init(storeName: String, storeAddress: String, isSaved: Bool,
       designName: String, iamgeUrls: [String], themes: [String],
       priceBySize: [String: String], kindOfCreams: [String], kindOfSheets: [String] ) {
